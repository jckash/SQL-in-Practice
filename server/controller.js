...
module.exports = {
    ...
    getPendingAppointments:(req, res) => {
        sequalize.query(`select * from cc_appointments
    ...
    getPastAppointments:(req, res) => {
        sequalize.query(`select a.appt_id, a.date, a.service_type, a.notes, u.first_name, u.last_name
        from cc_appointments a 
        join cc_emp_appts ea on a.appt_id = ea.appt_id
        oin cc_employees e on e.emp_id = ea.emp_id
        join cc_users u on e.user_id = u.user_id
